				...
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="flower-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="pixel-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="hollow-dots-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="intersecting-circles-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="radar-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="scaling-squares-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="half-circle-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="trinity-rings-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="fulfilling-square-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								...
								editor.insertContent('[epicspin type="circles-to-rhombuses-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								var random_string_thingy;
								random_string_thingy = Math.random().toString(36).substring(7);
								editor.insertContent('[epicspin type="semipolar-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="self-building-square-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="swapping-squares-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="fulfilling-bouncing-circle-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="fingerprint-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="spring-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="looping-rhombuses-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
				{
					...
					onclick: function() {
						editor.windowManager.open({
							...
							onsubmit: function(e) {
								editor.insertContent('[epicspin type="breeding-rhombus-spinner" color="' + e.data.color + '" size="' + e.data.pixel_size + '"]');
							}
						});
					}
				},
